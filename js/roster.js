const basePlayers = [
    // Forwards
    { id: 1,  name: "Edrice Mujeyi",           nickname: "Nawaz",    position: "Forward",    number: 15, goals: 8, assists: 3,  playerImage: "images/idris.jpg"    },
    { id: 2,  name: "Blessing Zvinoitavamwe",  nickname: "Bleja",    position: "Forward",    number: 9,  goals: 0, assists: 0,  playerImage: "images/bleja.jpg"    },
    { id: 3,  name: "Abel Makuvise",           nickname: "Svari",    position: "Forward",    number: 11, goals: 1, assists: 2,  playerImage: "images/svari1.jpg"   },
    { id: 4,  name: "Vincent Mukumba",         nickname: "Vincho",   position: "Forward",    number: 7,  goals: 3, assists: 3,  playerImage: "images/vincho.jpg"   },
    { id: 5,  name: "Shephard Mukarati",       nickname: "PSG",      position: "Forward",    number: 17, goals: 0, assists: 0,  playerImage: "images/psg.jpg"      },
    ...
    { id: 8,  name: "Kudzai Muganhu",          nickname: "Mahrez",     position: "Forward",    number: 30, goals: 1, assists: 2,  playerImage: "images/mahrez.jpg"     },
    ...
    // Defenders
    { id: 18, name: "Lordship Sithole",        nickname: "Lord",     position: "Defender",   number: 5,  goals: 0,  assists: 0,  cleansheets: 16, playerImage: "images/lord.jpg"     },
    { id: 19, name: "Nokutenda Makumbe",       nickname: "Noku",     position: "Defender",   number: 4,  goals: 0,  assists: 0,  playerImage: "images/noku.jpg"     },
    ...
    { id: 22, name: "Patrick Chikwashiwa",   nickname: "Tsano",   position: "Defender",   number: 22, goals: 1,  assists: 0,  playerImage: "images/tsano.jpg"   },
    ...
    // Goalkeepers
    { id: 26, name: "Knowledge Sheche",  nickname: "Ba Rashy", position: "Goalkeeper", number: 1,  cleansheets: 2, SavePercentage: 60, playerImage: "images/rashy1.jpg" },
